...
Image {
    ...
    source: "image://plexydesk/titlebar-bg"; fillMode: Image.TileHorizontally
    ...
    Column {
        ...
        Item {
            ...
            Button {
                id: backButton
                action: webView.back; image: "image://plexydesk/go-previous-view"
            ...
            Button {
                ...
                action: webView.forward; image: "image://plexydesk/go-next-view"
            }

            UrlInput {
                id: urlInput
                anchors { left: nextButton.right; right: reloadButton.left }
                image: "image://plexydesk/display"
                onUrlEntered: {
            ...
            Button {
                ...
                action: webView.reload; image: "image://plexydesk/view-refresh"
            ...
            Button {
                id: stopButton
                anchors { right: quitButton.left; rightMargin: 10 }
                action: webView.stop; image: "image://plexydesk/edit-delete"
                visible: webView.progress < 1.0 && !header.urlChanged
            }
            ...
            Button {
                ...
                image: "image://plexydesk/go-jump-locationbar"; visible: header.urlChanged
            }
        }
    }
}
